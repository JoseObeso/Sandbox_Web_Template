...
$(document).ready(function () {
    ...
    $("#fecha_fin").change(function () {
        ...
        if (lc_fecha_fin > lc_fecha_inicio) {
            ...
            {
                $("#msj_nota_informativa_servicios_juridicos").html('<center><font size="-1" color="#D08800">Fecha Fin Menor que fecha Inicio, corrijalo...</font></center>');
                 $("#txt_nro_expediente")
                     .attr("disabled", true);
            }
    }); 
