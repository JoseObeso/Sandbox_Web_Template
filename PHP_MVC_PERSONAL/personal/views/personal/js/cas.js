                ...
                encontrados.forEach(function (filas) {
                    if (filas.encontro === '1') {
                        $("#select_personal_cas_existente").append('<option value="' + filas.id + '"  id = "' + filas.id +
                            ...
                            '" fecha_ingreso = "' + filas.fecha_ingreso +
                            '" fecha_termino = "' + filas.fecha_termino +
...
function leer_personal_cas_y_mostrarlo_en_etiquetas() {
    ...
    leer_nombre_sexo = $('#select_personal_cas_existente  option:selected').attr('nombre_sexo');
    ...
    leer_detalle_hijos = $('#select_personal_cas_existente  option:selected').attr('detalle_hijos');
