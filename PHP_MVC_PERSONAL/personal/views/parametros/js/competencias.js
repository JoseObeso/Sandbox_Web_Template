...
function grabar_nuevo_registro(lc_codigo, lc_descripcion) {
    ...
    $.ajax({
        data: datos_grabar,
        dataType: 'json',
        url: url + 'parametros/grabar_nuevo_registro_en_competencias',
        type: 'post',
        beforeSend: function () {
            $("#espera_grabacion")
                .show()
...
function  grabar_modificacion_de_registro(ln_id, lc_codigo, lc_descripcion) {
    ...
    $.ajax({
        ...
        dataType: 'json',
        url: url + 'parametros/grabar_modificar_competencias',
        type: 'post',
        beforeSend: function () {
            $("#espera_grabacion")
                .show()
...
function eliminar_registro(ln_id) {
    ...
    $.ajax({
        data: dato_eliminar,
        dataType: 'json',
        url: url + 'parametros/eliminar_registro_competencias',
        type: 'post',
        beforeSend: function () {
            $("#espera_grabacion")
                .fadeIn()
