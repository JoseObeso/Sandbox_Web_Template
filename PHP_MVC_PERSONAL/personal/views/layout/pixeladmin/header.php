...
<head>
    ...
    <link href="<?=RUTA_PUBLIC_CSS;?>select2.min.css" rel="stylesheet" type="text/css">
    <link href="<?=RUTA_PUBLIC_CSS;?>jquery.multiselect.css" rel="stylesheet" type="text/css">
    <link href="<?=RUTA_PUBLIC_CSS;?>jquery.timepicker.min.css" rel="stylesheet" type="text/css">
    
        
    
     
    <script type="text/javascript" src="<?=RUTA_PUBLIC_JS;?>datatables.min.js"></script>
    <script type="text/javascript" src="<?=RUTA_PUBLIC_JS;?>jquery.multiselect.js"></script>
    <script type="text/javascript" src="<?=RUTA_PUBLIC_JS;?>jquery.timepicker.min.js"></script>
            ...
            <div id="main-menu-inner">
                ...
                <ul class="navigation">
                    ...
                    <li class="mm-dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-sitemap"></i> Acceso Modulos</a>
                        <ul class="dropdown">
                    ...
                    <li class="mm-dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="<?= RUTA_PUBLIC_PERFIL.$_SESSION["usuario"]["foto"]  ?>" alt="" width="15" height="15"> <span><?= $_SESSION["usuario"]["nombres"] ?></span></a>
                        <ul class="dropdown">
