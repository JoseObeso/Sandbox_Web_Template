...
function grabar_departamento_nuevo(leer_id_upss, leer_departamento_de_upss) {
    "use strict";
    var data_registrar_departamento = {
...
function listar_departamentos_de_upss() {
    "use strict";
...
function listar_todos_los_servicios_de_departamento_upss() {
    "use strict";
    var data_listar_servicios = {
        'idservicio': ''
    };
    $.ajax({
...
$(document).ready(function () {
    ...
    $("#slt_upss_seleccion").change(function () {
        leer_id_upss = $('#slt_upss_seleccion option:selected').attr('id');
        $("#txt_departamento")
            .attr("disabled", false)
            .focus();
    });
    ...
    $("#btn_grabar_servicios").click(function () {
        ...
        if (lc_tipo_operacion_servicios === '1') {
            ...
            leer_id_upss_seleccion = (typeof leer_id_upss_seleccion === 'undefined') ? leer_idupss_servicio : leer_id_upss_seleccion;
            leer_id_depar_seleccion = (typeof leer_id_depar_seleccion === 'undefined') ? leer_iddepar_servicio : leer_id_depar_seleccion;
