        ...
        success: function (encontrados) {
            ...
            if (nro_registros > 1) {
                ...
                encontrados.forEach(function (filas) {
                    $("#id_programacion").append('<option value="' + filas.dia + '" id = "' + filas.id + '" nombre_dia = "' + filas.dia_nombre + '" nro_dia = "' + filas.dia + '" entrada = "' + filas.entrada + '" salida = "' + filas.salida + '" horas = "' + filas.horas + '"  >' + filas.dia + ' - ' + filas.dia_nombre + ' - ' + filas.horario + ' - ' + filas.turno + ' - ' + filas.entrada + ' - ' + filas.salida + '</option>');
                });
        ...
        success: function (datos) {
            ...
            if (cantidad_registros > 0) {
                for (i = 0; i < datos.length; i++) {
                    valor_final = '<tr><td>' + datos[i].departamento + '</td><td>' + datos[i].servicio + '</td><td><center>' + datos[i].actividad + '</center></td><td>' + datos[i].dia + '/' + datos[i].mes + '/' + datos[i].anio + '</td><td><center>' + datos[i].turno + '</center></td><td><center>' + datos[i].horas + '</center></td></tr>';
