...
class mantenimientoModel extends Model
{
	...
	public function getListadoUsuarios(usuario_web $u)
	{		
	...
	public function getListarUnidadesOrganicas()
	{
	...
	public function getDatosUsuario(usuario_web $u)
	{
	...
	public function getPermisosUsuario(usuario_web $u, acceso_modulo $am)
	{		
	...
	public function cambiar_estado_menu(acceso_modulo $am, acceso_menu $a_menu)
	{
	...
	public function cambiar_estado_submenu(acceso_submenu $a_submenu, usuario_web $u, acceso_modulo $am)
	{
	...
	public function cambiar_estado_boton(acceso_botones $a_boton, usuario_web $u, acceso_submenu $a_submenu)
	{
	...
	public function getTodosLosBotones(acceso_submenu $a_submenu, usuario_web $u)
	{
		$sentencia = "select * from acceso_botones where id_submenu=? and dni=?";
		$resultado = $this->_db->prepare($sentencia);
