...
<div id="main-wrapper">
                        ...
                        <ul class="nav navbar-nav pull-right right-navbar-nav">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="divider"></li>
                                    <li><a href="<?= SERVIDOR ?>control/salir/"><i class="dropdown-icon fa fa-power-off"></i>&nbsp;&nbsp;Salir</a></li>
                                </ul>
                            </li>
                        </ul> 
                    </div>
    ...
    <div id="mensaje-error" class="modal modal-alert modal-danger fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <i class="fa fa-times-circle" style="font-size:50px;"></i>
                </div>
                <div class="modal-title">Mensaje de error:</div>
    ...
    <div id="mensaje-informacion" class="modal modal-alert modal-info fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <i class="fa fa-info-circle" style="font-size:50px;"></i>
                </div>
                <div class="modal-title">Mensaje de información:</div>
                <div class="modal-body"></div>
                <div class="modal-footer">
    ...
    <div id="mensaje-correcto" class="modal modal-alert modal-success fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <i class="fa fa-check-circle" style="font-size:50px;"></i>
                </div>
                <div class="modal-title">Mensaje:</div>
                <div class="modal-body"></div>
                <div class="modal-footer">
