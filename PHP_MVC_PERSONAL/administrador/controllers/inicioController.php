...
class inicioController extends Controller {
    ...
    public
    function index() {
        $this->_view->titulo = 'Bienvenido al Modulo de Administrador del Sistema de Monitoreo de RRHH - ' . INSTITUCION;
        ...
        $this->_view->ver_usuarios_soporte_tecnico = $this->_ver_estadistica->verusuariossoportetecnico();
