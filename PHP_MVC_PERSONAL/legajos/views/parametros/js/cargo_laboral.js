...
function grabar_nuevo_documento() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        url: url + 'parametros/grabar_nueva_cargo_laboral',
        type: 'post',
        beforeSend: function () {},
        success: function () {
            $('#btn_Grabar').attr("disabled", true);
            swal("Grabacion de nuevo tipo de cargo laboral.... conforme..");
...
function grabar_edicion_documento() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        url: url + 'parametros/grabar_edicion_cargo_laboral',
        type: 'post',
        beforeSend: function () {},
        success: function () {
            $('#btn_Grabar').attr("disabled", true);
            swal("Grabacion de edicion de cargo laboral.... conforme..");
            window.location.reload();
        }
    });
...
function eliminar_documento() {
    ...
    $.ajax({
        data: dato_eliminar,
        dataType: 'json',
        url: url + 'parametros/eliminar_cargo_laboral',
        type: 'post',
        beforeSend: function () {},
        success: function () {
            $('#btn_Grabar').attr("disabled", true);
...
$(document).ready(function () {
    ...
    $("#btn_eliminar").click(function () {
        swal({
            title: "Seguro de eliminar Tipo de Cargo Laboral ",
            text: "",
            type: "info",
