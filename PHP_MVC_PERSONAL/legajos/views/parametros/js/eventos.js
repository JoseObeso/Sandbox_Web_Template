...
function grabar_nuevo_documento() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        url: url + 'parametros/grabar_nueva_evento',
        type: 'post',
        beforeSend: function () {},
        success: function () {
            $('#btn_Grabar').attr("disabled", true);
...
function grabar_edicion_documento() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        url: url + 'parametros/grabar_edicion_evento',
        type: 'post',
        beforeSend: function () {},
        success: function () {
            $('#btn_Grabar').attr("disabled", true);
            swal("Grabacion de edicion de evento.... conforme..");
            window.location.reload();
        }
    });
...
function eliminar_documento() {
    ...
    $.ajax({
        data: dato_eliminar,
        dataType: 'json',
        url: url + 'parametros/eliminar_evento',
        type: 'post',
        beforeSend: function () {},
        success: function () {
            $('#btn_Grabar').attr("disabled", true);
