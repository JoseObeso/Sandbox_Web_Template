...
function grabar_nuevo_documento() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        url: url + 'parametros/grabar_nueva_tipo_educacion',
        type: 'post',
        beforeSend: function () {},
        success: function () {
            $('#btn_Grabar').attr("disabled", true);
            swal("Grabacion de nuevo tipo de educacion.... conforme..");
...
function grabar_edicion_documento() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        url: url + 'parametros/grabar_edicion_tipo_educacion',
        type: 'post',
        beforeSend: function () {},
        success: function () {
            $('#btn_Grabar').attr("disabled", true);
            swal("Grabacion de edicion de tipo de educacion.... conforme..");
            window.location.reload();
        }
    });
...
function eliminar_documento() {
    ...
    $.ajax({
        data: dato_eliminar,
        dataType: 'json',
        url: url + 'parametros/eliminar_tipo_educacion',
        type: 'post',
        beforeSend: function () {},
        success: function () {
            $('#btn_Grabar').attr("disabled", true);
...
$(document).ready(function () {
    ...
    $("#btn_eliminar").click(function () {
        swal({
            title: "Seguro de eliminar Tipo de Educacion ",
            text: "",
            type: "info",
