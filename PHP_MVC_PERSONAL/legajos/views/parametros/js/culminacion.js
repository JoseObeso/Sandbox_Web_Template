...
function grabar_nuevo_documento() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        url: url + 'parametros/grabar_nueva_culminacion',
        type: 'post',
        beforeSend: function () {},
        success: function () {
            $('#btn_Grabar').attr("disabled", true);
            swal("Grabacion de nuevo tipo de motivos de cese... conforme..");
...
function grabar_edicion_documento() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        url: url + 'parametros/grabar_edicion_culminacion',
        type: 'post',
        beforeSend: function () {},
        success: function () {
            $('#btn_Grabar').attr("disabled", true);
            swal("Grabacion de edicion de motivos de cese.... conforme..");
            window.location.reload();
        }
    });
...
function eliminar_documento() {
    ...
    $.ajax({
        data: dato_eliminar,
        dataType: 'json',
        url: url + 'parametros/eliminar_culminacion',
        type: 'post',
        beforeSend: function () {},
        success: function () {
            $('#btn_Grabar').attr("disabled", true);
...
$(document).ready(function () {
    ...
    $("#btn_eliminar").click(function () {
        swal({
            title: "Seguro de eliminar Tipo de motivos de cese",
            text: "",
            type: "info",
