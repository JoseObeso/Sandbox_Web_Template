...
// define('DIRECCION_URL', 'http://www.heves.gob.pe/rrhh/');
define('DIRECCION_URL', 'http://localhost/rrhh/');
define('INSTITUCION', 'HOSPITAL DE EMERGENCIA DE VILLA EL SALVADOR - LIMA - PERU ');
define('ENLACE', 'asistencia');
define('DSN_W', 'odbc:Driver={SQL Server};Server=MeryEdel;Database=HEVES_RRHH; Uid=sa; Pwd=12345678;');
...
define('RUTA_PUBLIC_LIB', $_SERVER['DOCUMENT_ROOT'].'/rrhh/public/libs/');
