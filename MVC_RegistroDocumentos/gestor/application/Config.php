<?php
define('DIRECCION_URL', 'http://localhost/tramite/');
define('INSTITUCION', 'HOSPITAL JOSE AGURTO TELLO DE CHOSICA ');
define('DSN_W', 'odbc:Driver={SQL Server};Server=MeryEdel;Database=TRAMITE; Uid=sa; Pwd=12345678;');
define('NOMBRE_APP', 'gestor');
