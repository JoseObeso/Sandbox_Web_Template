...
<script src="<?= $_layoutParams["ruta_js"];?>pixel-admin.min.js"></script>
<script src="<?= $_layoutParams['ruta_js'];?>demo.js"></script> 
<script src="<?= $_layoutParams['ruta_js'];?>select2.min.js"></script> 
<script src="<?= $_layoutParams['ruta_js'];?>header.js"></script> 
<script src="<?= $_layoutParams['ruta_js'];?>moment.min.js"></script> 
<script src="<?= $_layoutParams['ruta_js'];?>daterangepicker.js"></script> 
<script src="<?= $_layoutParams['ruta_js'];?>Chart.min.js"></script> 

<script type="text/javascript" src="<?=RUTA_PUBLIC_JS;?>datatables.min.js"></script>
<script type="text/javascript" src="<?=RUTA_PUBLIC_JS;?>jquery.dataTables.min.js"></script>
...
<script type="text/javascript" src="<?=RUTA_PUBLIC_JS;?>jquery.tablesorter.min.js"></script>
<script type="text/javascript" src="<?=RUTA_PUBLIC_JS;?>formatos_fechas_horas.js"></script>
<script type="text/javascript" src="<?=RUTA_PUBLIC_JS;?>pagination.min.js"></script>
