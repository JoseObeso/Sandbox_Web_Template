<?php
class integridadModel extends Model
{
    public
    ...
    public function Listar()
    {
        ...
        $query =  "select iddocencia, anio, descripcion, archivo, dfecharegistro, usuario, tipo, codigo  from docencia where tipo = 'N' order by anio desc;";
    ...
    public function Grabar($anio, $descripcion, $archivo, $user)
    {
        ...
        $sql_update_registro = $sql_update_registro . " values ( '" . $anio . "', '" . $descripcion . "', '" . $archivo . "', '" . $user . "', 'N', now())";
