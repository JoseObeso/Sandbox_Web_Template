<?php
class farmacovigilanciaModel extends Model
{
    public
    ...
    public function Listar()
    {
        ...
        $query =  "select iddocencia, anio, descripcion, archivo, dfecharegistro, usuario, tipo, codigo  from docencia where tipo = 'F' order by anio desc;";
