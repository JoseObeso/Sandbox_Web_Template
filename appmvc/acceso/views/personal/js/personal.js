var modulo = "/appmvc",
    ...
    url_ruta_archivos = 'http://' + document.domain + '/unidades/personal/pdf/',
    galerias_nombres = [],
            ...
            if (data[0].respuesta == 1) {
                if (data.length > 0) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        datos_en_fila += '<tr>';
                        datos_en_fila += '<td><button type="button" name="eliminar" id="' + data[i].id + '" class="btn btn-danger  btn_eliminar_resolucion">X</button></td>';
...
function listar_galeria() {
    ...
    $.ajax({
        dataType: 'json',
        url: url + 'personal/listar_galerias',
        type: 'post',
        beforeSend: function() {
...
function listar_categoria() {
    ...
    $.ajax({
        dataType: 'json',
        url: url + 'personal/listar_categoria',
        type: 'post',
        beforeSend: function() {
            etiqueta_msj.html("<center><img src='" + url_grafico + "/cargando.gif' width='128' height='15' alt=''/></center>");
        },
            ...
            if (data[0].respuesta == 1) {
                if (data.length > 0) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        datos_en_fila += '<td><button type="button" name="eliminar" id_baner="' + data[i].id + '" class="btn btn-danger  btn_eliminar_banner">X</button></td>';
                        datos_en_fila += '</tr>';
                    }
...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn_eliminar_resolucion', function() {
        var lc_leer_id = $(this).attr("id");
        $('#id_eliminar_resolucion').val(lc_leer_id);
    ...
    $("#si_eliminar_resolucion").click(function() {
        var leer_id = $('#id_eliminar_resolucion').val(),
    ...
    $("#imagen-multiple").change(function() {
        ...
        for (i = 0; i < fileLength; i++) {
            ...
            if (!((imagefile == match[0]) || (imagefile == match[1]) || (imagefile == match[2]) || (imagefile == match[3]))) {
                ...
                $.ajax({
                    dataType: 'json',
                    url: url + 'personal/multiples_imagenes',
                    type: 'post',
                    data: data_form,
                    contentType: false,
                    cache: false,
    ...
    $("#btn_grabar_galeria").click(function() {
        ...
        $.ajax({
            data: datos_grabar,
            dataType: 'json',
            url: url + 'personal/grabar_galeria',
            type: 'post',
            beforeSend: function() {
                $("#msj_imagen").html("<center><img src='" + url_grafico + "/cargando.gif' width='128' height='15' alt=''/></center>");
            },
    ...
    $("#si_eliminar_galeria").click(function() {
        ...
        $.ajax({
            data: data_eliminar,
            dataType: 'json',
            url: url + 'personal/eliminar_galeria',
            type: 'post',
            beforeSend: function() {
    ...
    $("#btn_grabar_Categoria").click(function() {
        ...
        $.ajax({
            data: datos_cat,
            dataType: 'json',
            url: url + 'personal/grabar_categoria',
            type: 'post',
            beforeSend: function() {},
            success: function() {
    ...
    $("#si_eliminar_categoria").click(function() {
        ...
        $.ajax({
            data: data_eliminar,
            dataType: 'json',
            url: url + 'personal/eliminar_categoria',
            type: 'post',
            beforeSend: function() {},
            success: function() {
    ...
    $(document).on('click', '.btn_eliminar_banner', function() {
        var lc_leer_id_baner = $(this).attr("id_baner");
    ...
    $("#si_eliminar_jefe").click(function() {
        var leer_id = $('#id').val(),
            data_eliminar_banner = { 'id': leer_id };
        $.ajax({
            data: data_eliminar_banner,
