...
function listar_categoria() {
    ...
    $.ajax({
        dataType: 'json',
        url: url + 'presupuestal/listar_categoria',
        type: 'post',
        beforeSend: function() {
...
$(document).ready(function() {
    ...
    $("#subir_archivo").change(function() {
        ...
        archivo_subir = this.files[0],
            ...
            msj_dom = $("#msj_subida");
        if (archivo_subir["size"] > 30000000) {
            etiqueta_dom.val("");
            msj_dom.html("<center><strong><font color='red'> --- Tamaño Maximo es 30 Megas, Vuelva a subir --- </font><strong></center>").show();
        } else {
            ...
            $.ajax({
                dataType: 'json',
                url: url + 'presupuestal/subir_pdf',
                type: 'post',
                data: data_form,
                contentType: false,
                cache: false,
    ...
    $("#btn_grabar_Categoria").click(function() {
        ...
        $.ajax({
            data: datos_cat,
            dataType: 'json',
            url: url + 'presupuestal/grabar_categoria',
            type: 'post',
            beforeSend: function() {},
            success: function() {
    ...
    $("#si_eliminar_categoria").click(function() {
        ...
        $.ajax({
            data: data_eliminar,
            dataType: 'json',
            url: url + 'presupuestal/eliminar_categoria',
            type: 'post',
            beforeSend: function() {},
            success: function() {
