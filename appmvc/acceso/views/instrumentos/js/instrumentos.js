...
function listar_categoria() {
    ...
    $.ajax({
        dataType: 'json',
        url: url + 'instrumentos/listar_categoria',
        type: 'post',
        beforeSend: function() {
...
$(document).ready(function() {
    ...
    $("#subir_archivo").change(function() {
        ...
        if (archivo_subir["size"] > 30000000) {
            ...
            $.ajax({
                dataType: 'json',
                url: url + 'instrumentos/subir_pdf',
                type: 'post',
                data: data_form,
                contentType: false,
                cache: false,
    ...
    $("#btn_grabar_Categoria").click(function() {
        ...
        $.ajax({
            data: datos_cat,
            dataType: 'json',
            url: url + 'instrumentos/grabar_categoria',
            type: 'post',
            beforeSend: function() {},
            success: function() {
    ...
    $("#si_eliminar_categoria").click(function() {
        ...
        $.ajax({
            data: data_eliminar,
            dataType: 'json',
            url: url + 'instrumentos/eliminar_categoria',
            type: 'post',
            beforeSend: function() {},
            success: function() {
