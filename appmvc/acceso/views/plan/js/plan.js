var modulo = "/appmvc",
    ...
    url_ruta_archivos = 'http://' + document.domain + '/transparencia/planeamiento/pdf/',
    galerias_nombres = [],
...
$(document).ready(function() {
    ...
    $("#btn_grabar").click(function() {
        var lc_anio = $("#anio").val(),
            ...
            lc_identificador = $('#mostrar_categoria option:selected').attr('clasificador'),
    ...
    $("#txtDescripcion_Categoria").keypress(function() {
        $("#txtClasificador").attr("disabled", false);
        $("#btn_grabar_Categoria").attr("disabled", true);
    });

    $("#txtClasificador").keypress(function() {
    ...
    $("#btn_grabar_Categoria").click(function() {
        var lc_categoria = $("#txtDescripcion_Categoria").val(),
            lc_clasificador = $("#txtClasificador").val(),
            datos_cat = {
                'nombre': lc_categoria,
                'clasificador': lc_clasificador
            };
    ...
    $("#si_eliminar_categoria").click(function() {
        ...
        $.ajax({
            data: data_eliminar,
            dataType: 'json',
            url: url + 'plan/eliminar_categoria',
            type: 'post',
            beforeSend: function() {},
            success: function() {
