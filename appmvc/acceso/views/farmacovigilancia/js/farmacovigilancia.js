 var modulo = "/appmvc",
     ...
     url_ruta_archivos = 'http://' + document.domain + '/pdf/farmacovigilancia/',
 ...
 function listar() {
     var etiqueta_msj = $("#msj-titular"),
         etiqueta_table = $('#mostrar-datos-interno');
     $.ajax({
         dataType: 'json',
         url: url + 'farmacovigilancia/listar',
         type: 'post',
         beforeSend: function() {
 ...
 $(document).ready(function() {
     ...
     $("#subir_archivo").change(function() {
         ...
         if (archivo_subir["size"] > 5000000) {
             ...
             $.ajax({
                 dataType: 'json',
                 url: url + 'farmacovigilancia/subir_pdf',
                 type: 'post',
                 data: data_form,
                 contentType: false,
                 cache: false,
     ...
     $("#btn_grabar").click(function() {
         ...
         $.ajax({
             data: datos,
             dataType: 'json',
             url: url + 'farmacovigilancia/grabar',
             type: 'post',
             beforeSend: function() {
     ...
     $("#si_eliminar").click(function() {
         ...
         $.ajax({
             data: data_eliminar,
             dataType: 'json',
             url: url + 'farmacovigilancia/eliminar',
             type: 'post',
             beforeSend: function() {},
             success: function() {
