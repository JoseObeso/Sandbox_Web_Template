var modulo = "/appmvc",
    ...
    url_ruta_archivos = 'http://' + document.domain + '/unidades/calidad/pdf/',
    galerias_nombres = [],
...
function listar_galeria() {
    ...
    $.ajax({
        dataType: 'json',
        url: url + 'calidad/listar_galerias',
        type: 'post',
        beforeSend: function() {
...
function listar_categoria() {
    ...
    $.ajax({
        dataType: 'json',
        url: url + 'calidad/listar_categoria',
        type: 'post',
        beforeSend: function() {
            etiqueta_msj.html("<center><img src='" + url_grafico + "/cargando.gif' width='128' height='15' alt=''/></center>");
        },
...
$(document).ready(function() {
    ...
    $("#imagen-multiple").change(function() {
        ...
        for (i = 0; i < fileLength; i++) {
            ...
            if (!((imagefile == match[0]) || (imagefile == match[1]) || (imagefile == match[2]) || (imagefile == match[3]))) {
                ...
                $.ajax({
                    dataType: 'json',
                    url: url + 'calidad/multiples_imagenes',
                    type: 'post',
                    data: data_form,
                    contentType: false,
                    cache: false,
    ...
    $("#btn_grabar_galeria").click(function() {
        ...
        $.ajax({
            data: datos_grabar,
            dataType: 'json',
            url: url + 'calidad/grabar_galeria',
            type: 'post',
            beforeSend: function() {
                $("#msj_imagen").html("<center><img src='" + url_grafico + "/cargando.gif' width='128' height='15' alt=''/></center>");
            },
    ...
    $("#si_eliminar_galeria").click(function() {
        ...
        $.ajax({
            data: data_eliminar,
            dataType: 'json',
            url: url + 'calidad/eliminar_galeria',
            type: 'post',
            beforeSend: function() {
    ...
    $("#btn_grabar_Categoria").click(function() {
        ...
        $.ajax({
            data: datos_cat,
            dataType: 'json',
            url: url + 'calidad/grabar_categoria',
            type: 'post',
            beforeSend: function() {},
            success: function() {
    ...
    $("#si_eliminar_categoria").click(function() {
        ...
        $.ajax({
            data: data_eliminar,
            dataType: 'json',
            url: url + 'calidad/eliminar_categoria',
            type: 'post',
            beforeSend: function() {},
            success: function() {
