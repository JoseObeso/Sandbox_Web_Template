<?php
class izquierdoController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->_view->setJs(array('izquierdo'));
    ...
    public function listar()
    {
        ...
        $anio = $_POST["anio"];
        $mes = $_POST["mes"];
        $this->_listar = $this->loadModel('izquierdo');
    ...
    public function grabar()
    {
        ...
        $this->registrar = $this->loadModel('izquierdo');
    ...
    public function eliminar()
    {
        $id = $_POST["id"];
        $dni = trim($_SESSION["usuario"]["usuario"]);
        $this->eliminar_ = $this->loadModel('izquierdo');
