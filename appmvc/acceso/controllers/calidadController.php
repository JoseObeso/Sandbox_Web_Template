...
class calidadController extends Controller
{
    ...
    {
        $this->_view->titulo = 'Calidad - ' . INSTITUCION;
        $this->_view->setJs(array('calidad'));
        $this->_view->renderizar('index', false);
    }

    public function listar()
    {
        $this->_listar = $this->loadModel('calidad');
    ...
    public function subir_pdf()
    {
        ...
        $anio = $_POST["anio"];
        $destino = $_SERVER['DOCUMENT_ROOT'] . '/unidades/calidad/pdf/' . $anio . '/';
    ...
    public function grabar()
    {
        ...
        $this->registrar = $this->loadModel('calidad');
    ...
    {
        $id = $_POST["id"];
        $this->eliminar_ = $this->loadModel('calidad');
    ...
    public function multiples_imagenes()
    {
        ...
        $ruta = $_SERVER['DOCUMENT_ROOT'] . '/unidades/calidad/maq_calidad/images/galeria/';
    ...
    public function grabar_galeria()
    {
        ...
        $user = trim($_SESSION["usuario"]["user"]);
        $this->registrar_agenda = $this->loadModel('calidad');
    ...
    {
        $id = $_POST["id"];
        $this->eliminar = $this->loadModel('calidad');
