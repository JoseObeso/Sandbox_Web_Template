<?php
class emergentesController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->_view->setJs(array('emergentes'));
    ...
    public function listar()
    {
        ...
        $anio = $_POST["anio"];
        $mes = $_POST["mes"];
        $this->_listar = $this->loadModel('emergentes');
    ...
    public function subir_imagen1()
    {
        ...
        $ruta = $_SERVER['DOCUMENT_ROOT'] . '/images/emergentes/';
    ...
    public function grabar()
    {
        ...
        $tipo_dimension = $_POST["tipo_dimension"];  
        $dni = trim($_SESSION["usuario"]["usuario"]);
        $this->registrar = $this->loadModel('emergentes');
        $ejecutar_grabar = $this->registrar->Grabar($descripcion, $imagen1, $dni, $tipo_dimension);
    ...
    public function eliminar()
    {
        $id = $_POST["id"];
        $dni = trim($_SESSION["usuario"]["usuario"]);
        $this->eliminar_prensa = $this->loadModel('emergentes');
