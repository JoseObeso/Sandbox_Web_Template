...
class integridadController extends Controller
{
    ...
    {
        $this->_view->titulo = 'INTEGRIDAD - ' . INSTITUCION;
        $this->_view->setJs(array('integridad'));
        $this->_view->renderizar('index', false);
    }

    public function listar()
    {
        $this->_listar = $this->loadModel('integridad');
    ...
    public function subir_pdf()
    {
        ...
        $anio = $_POST["anio"];
        $destino = $_SERVER['DOCUMENT_ROOT'] . '/pdf/integridad/' . $anio . '/';
    ...
    public function grabar()
    {
        ...
        $this->registrar = $this->loadModel('integridad');
    ...
    {
        $id = $_POST["id"];
        $this->eliminar_ = $this->loadModel('integridad');
