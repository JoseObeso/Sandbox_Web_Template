...
class personalController extends Controller
{
    ...
    {
        $this->_view->titulo = 'Personal - ' . INSTITUCION;
    ...
    {
        $this->_listar = $this->loadModel('personal');
    ...
    public function grabar()
    {
        ...
        $this->registrar = $this->loadModel('personal');
    ...
    {
        $id = $_POST["id"];
        $this->eliminar_ = $this->loadModel('personal');
    ...
    public function grabar_galeria()
    {
        ...
        $user = trim($_SESSION["usuario"]["user"]);
        $this->registrar_agenda = $this->loadModel('personal');
    ...
    {
        $id = $_POST["id"];
        $this->eliminar = $this->loadModel('personal');
