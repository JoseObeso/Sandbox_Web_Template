...
class derechoController extends Controller
{
    ...
    {
        $this->_view->titulo = 'Graficos Lado Derecho' . INSTITUCION;
        $this->_view->setJs(array('derecho'));
    ...
    public function listar()
    {
        ...
        $anio = $_POST["anio"];
        $mes = $_POST["mes"];
        $this->_listar = $this->loadModel('derecho');
    ...
    public function subir_imagen1()
    {
        ...
        $ruta = $_SERVER['DOCUMENT_ROOT'] . '/images/derecho/';
    ...
    public function grabar()
    {
        ...
        $this->registrar = $this->loadModel('derecho');
    ...
    public function eliminar()
    {
        $id = $_POST["id"];
        $dni = trim($_SESSION["usuario"]["usuario"]);
        $this->eliminar_ = $this->loadModel('derecho');
    ...
    public function grabar_orden()
    {
        $id = $_POST["id"];
        $orden = $_POST["orden"];
        $this->orden_ = $this->loadModel('derecho');
