...
class presupuestalController extends Controller
{
    ...
    {
        $this->_view->titulo = 'presupuestal - ' . INSTITUCION;
        $this->_view->setJs(array('presupuestal'));
        $this->_view->renderizar('index', false);
    }

    public function listar()
    {
        $this->_listar = $this->loadModel('presupuestal');
    ...
    public function subir_pdf()
    {
        ...
        $anio = $_POST["anio"];
        $destino = $_SERVER['DOCUMENT_ROOT'] . '/transparencia/presupuesto/pdf/' . $anio . '/';
    ...
    public function grabar()
    {
        ...
        $this->registrar = $this->loadModel('presupuestal');
    ...
    {
        $id = $_POST["id"];
        $this->eliminar_ = $this->loadModel('presupuestal');
