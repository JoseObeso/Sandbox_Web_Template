...
class enlacesController extends Controller
{
    ...
    {
        $this->_view->titulo = 'Graficos Enlaces Gubernamentales' . INSTITUCION;
        $this->_view->setJs(array('enlaces'));
    ...
    public function listar()
    {
        ...
        $anio = $_POST["anio"];
        $mes = $_POST["mes"];
        $this->_listar = $this->loadModel('enlaces');
    ...
    public function subir_imagen1()
    {
        ...
        $ruta = $_SERVER['DOCUMENT_ROOT'] . '/images/enlaces/';
    ...
    public function grabar()
    {
        ...
        $this->registrar = $this->loadModel('enlaces');
        $ejecutar_grabar = $this->registrar->Grabar($descripcion, $imagen1,  $enlace, $orden, $dni);
    ...
    public function eliminar()
    {
        $id = $_POST["id"];
        $dni = trim($_SESSION["usuario"]["usuario"]);
        $this->eliminar_ = $this->loadModel('enlaces');
    ...
    public function grabar_orden()
    {
        $id = $_POST["id"];
        $orden = $_POST["orden"];
        $this->orden_ = $this->loadModel('enlaces');
        $ejecutar_grabar = $this->orden_->GrabarOrden($id, $orden);
        echo $ejecutar_grabar;
    }
