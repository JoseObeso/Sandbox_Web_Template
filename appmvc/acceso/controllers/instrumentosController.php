...
class instrumentosController extends Controller
{
    ...
    {
        $this->_view->titulo = 'instrumentos - ' . INSTITUCION;
        $this->_view->setJs(array('instrumentos'));
        $this->_view->renderizar('index', false);
    }

    public function listar()
    {
        $this->_listar = $this->loadModel('instrumentos');
    ...
    public function grabar()
    {
        ...
        $this->registrar = $this->loadModel('instrumentos');
    ...
    {
        $id = $_POST["id"];
        $this->eliminar_ = $this->loadModel('instrumentos');
